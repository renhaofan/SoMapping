/*!
	...
	\details	Include rotation and translation. \n
				Define \f$ R \f$ is a rotation of 3 times 3 matrix.\n
				Define \f$ t \f$ is a translation of 3 times 1 vector.\n
				The pose matrix is defined as \f$ \begin{bmatrix}
					R & t\\ 
					0 & 1
					\end{bmatrix}\f$
...
public:
	...
	/*! 
		The matrix is saved as \f$ \begin{bmatrix}
								...
								m_3 & m_7 & m_{11} & m_{15}
								\end{bmatrix}\f$.
		The \f$ m_i \f$ is the \f$ i^{th} \f$ element of mat.data().
	*/
	Matrix4f mat;
	// CUDA pose array
	...
	//! Compute pose matrix by Trajectory_node, which represent rotation as quaternions.
	/*!
		\param	trace	The translation and rotation(represent as quaternions).
	...
	*/
	...
	//! Rotation and translation calculate the rigid body transformation independently of each other.
	/*!
		\param	pose_transformation		The rotation and translation.
