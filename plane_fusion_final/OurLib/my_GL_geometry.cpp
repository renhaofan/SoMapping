...
//        
void caculate_cube_vertex(My_Type::Vector3f * points, float width, float height, float depth)
{
	//
...
void draw_keyframe_pose(float rect_width, float aspect_ratio, float dapth_ratio)
{
	...
	points[0].x = half_width;		points[0].y = aspect_ratio * half_width;	points[0].z = dapth_ratio * half_width;
