...
//    Label
__global__ void render_plane_label_KernelFunc(
...
//
__global__ void render_plane_label_KernelFunc(
    int *plane_labels, My_Type::Vector4uc *points_color) {
...
__global__ void reduce_range_KernelFunc(
    const My_Type::Vector3f *dev_raw_aligned_points, int *min_depth,
    int *max_depth) {
...
//
__global__ void pseudo_render_depth_KernelFunc(
    const My_Type::Vector3f *dev_raw_aligned_points, const int *min_depth,
    const int *max_depth, My_Type::Vector4uc *color_buffer) {
  bool is_valid_depth = true;
