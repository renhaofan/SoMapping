...
//TODO
#pragma comment(lib,"C:/English_path/ceres-solver-1.14.0/ceres-solver-1.14.0-build/lib/Release/ceres.lib")
...
int main(int argc, char ** argv)
{
    ...
    if(argc == 2){
        ...
        printf("Please input 'calibration file' for online input,\n or 'calibration file, sequence dir, dataset mode(ICL:0,TUM:1,MyZR300:2,MyD435i:3,MyAzureKinect:4)' for offline input.");
        return 0;
    }
...
//
//	// Create Image_loader
//	Image_loader * image_loader_ptr = create_image_loader(color_folder, depth_folder);
//
    // Initiation
    ...
    if (false)
    {
        ...
        while (Main_engine::instance()->data_engine->load_next_frame(timestamp, color_mat, depth_mat, true))
        {	cv::waitKey(10);	}
    }
