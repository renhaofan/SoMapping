...
#define VOXEL_BLOCK_SIZE		(VOXEL_BLOCK_WDITH * VOXEL_BLOCK_WDITH * VOXEL_BLOCK_WDITH)
//   Voxel  				5mm
...
#define MIN_RAYCAST_WEIGHT	3


//   Voxel   
// float  voxel
typedef struct Voxel_f
{
	float sdf;
