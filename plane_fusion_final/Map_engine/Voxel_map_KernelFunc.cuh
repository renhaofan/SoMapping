...
void build_visible_list_CUDA(dim3 block_rect, dim3 thread_rect,
							 ...
							 int * visible_counter);
//--  From submap
void build_relative_list_CUDA(dim3 block_rect, dim3 thread_rect, HashEntry * entry, HashEntry * relative_list, char * relative_flag, \
	int * relative_counter, float * pose_inv);
