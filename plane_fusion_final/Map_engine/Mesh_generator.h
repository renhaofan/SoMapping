...
#pragma region(Non-planar region)
	...
	//
	const int max_number_of_triangle = (int)SUBMAP_VOXEL_BLOCK_NUM * VOXEL_BLOCK_WDITH * VOXEL_BLOCK_WDITH * 4;
#pragma endregion
...
#pragma endregion
	...
	*/
	void generate_mesh_from_voxel(HashEntry * dev_entry,
								  Voxel_f * dev_voxel_block_array,
								  std::vector<My_Type::Vector2i> relabel_plane_list = std::vector<My_Type::Vector2i>());
	...
	*/
	void generate_mesh_from_plane_array(std::vector<Plane_info> & plane_list,
