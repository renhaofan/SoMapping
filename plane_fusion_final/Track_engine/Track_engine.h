...
#pragma endregion
	...
	*/
#ifdef COMPILE_DEBUG_CODE
	virtual void generate_icp_correspondence_lines(const Hierarchy_image<My_Type::Vector3f> & dev_current_points_hierarchy,
...
public:
	...
	*/
	TrackingState track_camera_pose(const Hierarchy_image<My_Type::Vector3f> & dev_current_points_hierarchy,
									const Hierarchy_image<My_Type::Vector3f> & dev_model_points_hierarchy,
									const Hierarchy_image<My_Type::Vector3f> & dev_current_normals_hierarchy,
									const Hierarchy_image<My_Type::Vector3f> & dev_model_normals_hierarchy,
...
public:
	...
	//! Point-Plane hessian,nabla matrix
	Accumulate_result icp_accumulation, photometric_accumulation, *dev_accumulation_buffer;
