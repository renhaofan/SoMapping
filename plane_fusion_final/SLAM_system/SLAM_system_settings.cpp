...
//
void SLAM_system_settings::set_depth_image_size(const int & width, const int &  height, bool align_flag)
{
	//
	this->aligned_depth_size.width = ceil_by_stride(width, this->image_alginment_patch_width);
	this->aligned_depth_size.height = ceil_by_stride(height, this->image_alginment_patch_width);
}

//
void SLAM_system_settings::set_color_image_size(const int &  width, const int &  height, bool align_flag)
{
	//
	this->aligned_color_size.width = ceil_by_stride(width, this->image_alginment_patch_width);
	this->aligned_color_size.height = ceil_by_stride(height, this->image_alginment_patch_width);
}

//
void SLAM_system_settings::set_calibration_paramters(const float & fx, const float & fy, 
...
void SLAM_system_settings::set_extrinsic(const My_Type::Matrix44f d2c, const My_Type::Matrix44f d2i)
{
