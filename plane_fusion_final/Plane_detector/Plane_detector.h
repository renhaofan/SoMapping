...
public:
	...
	*/
	void match_planes(const Plane_info * model_planes,
...
protected:
	...
	*/
	virtual void presegment_to_cell(const My_Type::Vector3f * dev_current_points,
	...
	*/
	virtual void fit_plane_for_each_cell(const My_Type::Vector3f * dev_current_points,
										 const My_Type::Vector3f * dev_current_normals,
	...
	*/
	...
	//
	std::vector<std::pair<int, int>> find_most_overlap_model_plane(int current_plane_label, int model_plane_counter);
