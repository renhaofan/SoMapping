...
//
void Main_engine::init(int argc, char ** argv, Image_loader * image_loader_ptr, string output_folder, bool _is_ICL_NUIM_dataset)
{
...
#pragma region(System Initializer)
...
//	this->SLAM_system_ptr = new Basic_voxel_SLAM_system();
	...
	UI_engine::instance()->init(argc, argv, this->data_engine, this->SLAM_system_ptr, this->render_engine_ptr);
