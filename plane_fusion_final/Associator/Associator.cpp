...
void Associator::prepare_for_optimization()
{
	...
	this->all_submap_id_pair.insert(this->all_submap_id_pair.end(),
									this->tracked_submap_id_pair.begin(), this->tracked_submap_id_pair.end());
	this->all_submap_id_pair.insert(this->all_submap_id_pair.end(),
									this->relocalization_submap_id_pair.begin(), this->relocalization_submap_id_pair.end());
	this->all_matches.insert(this->all_matches.end(),
							 this->tracked_matches.begin(), this->tracked_matches.end());
	this->all_matches.insert(this->all_matches.end(),
							 this->relocalization_matches.begin(), this->relocalization_matches.end());
}
