...
#pragma endregion
	...
	/*!
		...
		\param	number_of_layers		Number of hierarchy image layers.

		\return	void
	*/
	virtual void init(My_Type::Vector2i raw_color_size, My_Type::Vector2i raw_depth_size,
					  int image_alignment_width,
	...
	*/
	virtual void preprocess_model_points(My_Type::Vector3f * dev_model_points, My_Type::Vector3f * dev_model_normals) = 0;
...
public:
	...
	//!
	void preprocess_model_points(My_Type::Vector3f * dev_model_points, My_Type::Vector3f * dev_model_normals) override;
