...
public:
	...
	*/
	bool load_next_frame(double & timestamp, 
						 cv::Mat & color_mat, cv::Mat & depth_mat, 
						 bool show_in_opencv = false);
	...
	/*!
		...
		\return void
	*/
	void load_ground_truth(string ground_truth_path, bool is_ICL_NUIM_data = false);


	//! Get Image_loader
	Image_loader * get_image_loader() const
